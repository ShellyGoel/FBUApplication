...
public class JClient {
    ...
    static {
        ...
        MEANINGCLOUD_KEY = BuildConfig.CONSUMER_KEY;
    ...
    public static String sentimentRequest (String txt) throws IOException, Request.ParameterValidationException {
        ...
        String score_tag = r.getScoreTag();
        Log.i("sentiment analysis", "score_tag: " + score_tag);
//        String language = r.getLanguageList().get(0).getLanguage();
//        String nameLang = r.getLanguageList().get(0).getName();
